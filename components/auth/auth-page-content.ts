/**
 * Onboarding note:
 * Feature UI module for auth page content. Keep server data ownership in the relevant Convex/hooks layer and use this file for presentation and local interaction only.
 */
