...
/**
 * Onboarding note:
 * Billing UI module for pricing cards. Keep display logic aligned with Convex credit tiers and route all payment state changes through provider-backed mutations/webhooks.
 */
