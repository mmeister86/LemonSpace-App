...
/**
 * Onboarding note:
 * Supports the Canvas editor workflow for canvas node template picker. Preserve the boundary between React Flow interaction state, Convex persistence, and local optimistic state.
 */
...
> = {
  ...
  comment: ["comment", "kommentar", "review", "thread"],
  ...
  "change-camera": ["camera", "angle", "perspective", "kamera", "winkel"],
