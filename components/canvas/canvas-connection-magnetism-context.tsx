...
/**
 * Onboarding note:
 * Supports the Canvas editor workflow for canvas connection magnetism context. Preserve the boundary between React Flow interaction state, Convex persistence, and local optimistic state.
 */
