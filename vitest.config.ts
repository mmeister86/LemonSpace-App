...
export default defineConfig({
  ...
  test: {
    ...
    include: [
      ...
      "components/canvas/__tests__/canvas-node-search.test.tsx",
      "components/canvas/__tests__/canvas-toolbar.test.tsx",
      "components/canvas/__tests__/canvas-zoom-controls.test.tsx",
      ...
      "lib/onboarding/__tests__/storage.test.ts",
