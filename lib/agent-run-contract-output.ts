/**
 * Onboarding note:
 * Shared TypeScript utility for agent run contract output. Keep it framework-light and reusable from both frontend and Convex-adjacent code where applicable.
 */
